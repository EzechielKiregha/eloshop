...
import {
  ...
  Package, BarChart3, Store, LogOut, Menu, ChevronLeft,
} from "lucide-react";
  ...
  return (
    <div className="flex h-full flex-col">
      <div className="flex h-16 items-center gap-2 border-b px-4">
        <Link href="/" className="text-lg font-bold tracking-tight">Elo&apos;Shop</Link>
    ...
    <div className="flex h-screen overflow-hidden bg-zinc-50 dark:bg-zinc-950">
      ...
      <div className="flex flex-1 flex-col overflow-hidden">
        <header className="flex h-16 items-center gap-4 border-b bg-white px-4 dark:bg-zinc-950 lg:hidden">
          ...
          <span className="text-lg font-bold">Elo&apos;Shop</span>
        </header>
