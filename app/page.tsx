...
import { ArrowRight, ShoppingBag, Store, Package, Truck, Phone, Mail, MapPin, MessageCircle } from "lucide-react";
...
const features = [
  { icon: ShoppingBag, title: "Large catalogue", text: "Vêtements, chaussures et accessoires sélectionnés avec soin pour un style premium." },
  { icon: Store, title: "Boutique & en ligne", text: "Achetez en magasin ou commandez en ligne, nous livrons partout." },
  { icon: Package, title: "Stock en temps réel", text: "Disponibilité mise à jour en continu entre la boutique et le site." },
  { icon: Truck, title: "Livraison rapide", text: "Commandez en ligne et recevez votre colis dans les meilleurs délais." },
];
    ...
    <main>
        ...
        <div className="relative mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
          <div className="grid min-h-[500px] items-center gap-8 lg:grid-cols-[1fr_1fr]">
            ...
            <div className="text-center lg:text-left">
              ...
              <p className="mx-auto mt-6 max-w-lg text-base leading-7 text-zinc-600 dark:text-zinc-400 lg:mx-0">
                Habillez votre style, affirmez votre personnalité. Votre destination mode à Butembo pour des vêtements, chaussures et accessoires de qualité.
              </p>

              <div className="mt-8 flex flex-wrap justify-center gap-3 lg:justify-start">
                <Button size="lg" asChild>
                  <Link href="/shop">Découvrir la boutique <ArrowRight className="ml-2 h-4 w-4" /></Link>
                </Button>
                <Button size="lg" variant="outline" className="border-gold-400/40 text-gold-600 hover:bg-gold-50 dark:text-gold-400 dark:hover:bg-gold-400/10" asChild>
                  <a href="https://wa.me/243978638104?text=Bonjour%20BOUTIQUE%20KAMEGA%2C%20je%20souhaite%20passer%20une%20commande." target="_blank" rel="noopener noreferrer">
              ...
              <div className="mt-6 inline-flex items-center gap-2 rounded-full border border-gold-400/30 bg-gold-400/10 px-4 py-1.5">
                ...
                <span className="text-xs font-semibold uppercase tracking-wider text-gold-600 dark:text-gold-400">Nouvelle Collection Disponible</span>
              </div>
            </div>
              ...
              <div className="absolute -bottom-4 left-6 right-6 rounded-xl border border-gold-400/20 bg-white/90 p-4 shadow-gold backdrop-blur dark:bg-zinc-900/90">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="mt-1 text-2xl font-semibold font-display text-zinc-900 dark:text-white">{productCount} <span className="text-sm text-zinc-400">articles</span></p>
                  </div>
                  <div className="h-10 w-px bg-gold-400/20" />
                  <div className="text-right">
                    <p className="text-xs text-zinc-500">Disponible</p>
                    <p className="mt-1 text-sm font-medium text-gold-500 dark:text-gold-400">Boutique &amp; En ligne</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="mt-16 grid grid-cols-2 gap-4 border-t border-gold-400/15 pt-8 sm:grid-cols-4 lg:grid-cols-5">
            <div className="flex items-center gap-2 text-zinc-500 dark:text-zinc-400">
              ...
              <div>
                <p className="text-[11px] font-semibold uppercase text-gold-500 dark:text-gold-400">Livraison</p>
            ...
            <div className="flex items-center gap-2 text-zinc-500 dark:text-zinc-400">
              ...
              <div>
                <p className="text-[11px] font-semibold uppercase text-gold-500 dark:text-gold-400">Commandes</p>
            ...
            <div className="flex items-center gap-2 text-zinc-500 dark:text-zinc-400">
              ...
              <div>
                <p className="text-[11px] font-semibold uppercase text-gold-500 dark:text-gold-400">Téléphone</p>
            ...
            <div className="flex items-center gap-2 text-zinc-500 dark:text-zinc-400">
              ...
              <div>
                <p className="text-[11px] font-semibold uppercase text-gold-500 dark:text-gold-400">Butembo</p>
            ...
            <div className="hidden items-center gap-2 text-zinc-500 dark:text-zinc-400 lg:flex">
              ...
              <div>
                <p className="text-[11px] font-semibold uppercase text-gold-500 dark:text-gold-400">En magasin</p>
      ...
      <section className="border-y border-gold-400/10 bg-white py-16 dark:bg-zinc-900">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mb-10 text-center">
            <h2 className="text-2xl font-semibold tracking-tight text-gold-gradient">Pourquoi BOUTIQUE KAMEGA ?</h2>
            <p className="mx-auto mt-3 max-w-2xl text-zinc-600 dark:text-zinc-400">
              Nous sélectionnons des pièces modernes et intemporelles pour hommes et femmes. Mode, qualité et service au meilleur prix.
            </p>
          </div>
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            {features.map((f) => (
              <div key={f.title} className="rounded-2xl border border-gold-400/10 bg-zinc-50 p-5 transition-shadow hover:shadow-gold dark:bg-zinc-950">
      ...
      {categories.length > 0 && (
        <section className="py-20">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <h2 className="text-2xl font-semibold tracking-tight">Nos catégories</h2>
            <p className="mt-2 text-sm text-zinc-500 dark:text-zinc-400">Explorez notre sélection par catégorie</p>
                ...
                >
                  {cat.image ? (
                    ...
                    <div className="flex aspect-square flex-col items-center justify-center gap-2 p-4">
                      ...
                      <p className="text-center text-sm font-semibold font-display">{cat.name}</p>
                    </div>
                  )}
                </Link>
              ))}
      ...
      <section className="border-t pb-20 pt-16">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex items-end justify-between">
            <div>
              <p className="text-sm font-semibold uppercase tracking-widest text-gold-500">Sélection</p>
      ...
      <section className="border-t bg-zinc-50 py-16 dark:bg-zinc-900">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mb-8 text-center">
            ...
            <p className="mt-2 text-sm text-zinc-500 dark:text-zinc-400">BOUTIQUE KAMEGA — Butembo, Nord-Kivu, République Démocratique du Congo</p>
          </div>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-4">
            ...
            <div className="sm:col-span-2 lg:col-span-1">
              ...
              />
              <h3 className="mt-4 font-display text-lg font-semibold text-gold-400">BOUTIQUE KAMEGA</h3>
              <p className="mt-2 max-w-xs text-sm leading-6 text-zinc-400">
                Habillement Mixte — Style, Élégance, Qualité. Vêtements, chaussures et accessoires de qualité à Butembo.
              </p>
            </div>

            {/* Boutique links */}
            <div>
              <h3 className="text-sm font-semibold uppercase tracking-wider text-gold-400/80">Boutique</h3>
              <ul className="mt-4 space-y-3">
                <li><Link href="/shop" className="text-sm text-zinc-300 hover:text-gold-400 transition">Tous les produits</Link></li>
                {categories.slice(0, 4).map((cat) => (
                  <li key={cat.id}><Link href={`/shop?category=${cat.slug}`} className="text-sm text-zinc-300 hover:text-gold-400 transition">{cat.name}</Link></li>
                ))}
              </ul>
            </div>
            ...
            {/* Account links */}
            <div>
              <h3 className="text-sm font-semibold uppercase tracking-wider text-gold-400/80">Mon compte</h3>
              <ul className="mt-4 space-y-3">
                <li><Link href="/login" className="text-sm text-zinc-300 hover:text-gold-400 transition">Se connecter</Link></li>
                <li><Link href="/register" className="text-sm text-zinc-300 hover:text-gold-400 transition">Créer un compte</Link></li>
                <li><Link href="/customer" className="text-sm text-zinc-300 hover:text-gold-400 transition">Mes commandes</Link></li>
                <li><Link href="/cart" className="text-sm text-zinc-300 hover:text-gold-400 transition">Panier</Link></li>
              </ul>
            </div>

            {/* Contact */}
            <div>
              <h3 className="text-sm font-semibold uppercase tracking-wider text-gold-400/80">Contact</h3>
              <ul className="mt-4 space-y-3">
                <li className="text-sm text-zinc-400">BOUTIQUE KAMEGA</li>
                <li className="text-sm text-zinc-400">Habillement Mixte</li>
                <li className="text-sm text-zinc-400 flex flex-row gap-2"><Phone className="h-4 w-4 text-gold-400"/>+243 978 638 104</li>
                <li className="text-sm text-zinc-400 flex flex-row gap-2"><MapPin className="h-4 w-4 text-gold-400"/>Butembo, Nord-Kivu, RDC</li>
                <li className="text-sm text-zinc-400 flex flex-row gap-2"><Mail className="h-4 w-4 text-gold-400"/>factorymusav@gmail.com</li>
                <li>
                  <a
          ...
          <div className="mt-10 border-t border-zinc-800 pt-6 flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
            <p className="text-xs text-zinc-500">&copy; {new Date().getFullYear()} BOUTIQUE KAMEGA. Tous droits réservés.</p>
